...
const Industries = ({ isActive = true }: IndustriesProps) => {
  ...
  return (
    <UiSection>
      <div ref={container} className="flex flex-col  gap-6 2xl:gap-16 h-full justify-center sm:pt-10 max-sm:justify-between ">
        ...
        <div className="flex flex-col gap-5 ">
          ...
          <div className="anim-subtitle will-change-transform text-xs sm:w-[736px] justify-start text-white xl:text-xl font-normal">
        ...
        <div className="flex  gap-5 sm:gap-20">
          <div className="w-full max-w-[35.87vw] shrink-0 flex flex-col justify-start items-start gap-7">
            
            <div className="anim-industry-item will-change-transform self-stretch flex flex-col justify-start items-start gap-3">
              <div className="self-stretch justify-center text-primary-100 text-xl max-xl:text-xs font-bold tracking-[4px]">
                CRYPTO AND WEB3
              </div>
              <div className="self-stretch text-base-300 justify-start text-sm  max-xl:text-[10px] font-light">
            ...
            <div className="anim-industry-item will-change-transform self-stretch flex flex-col justify-start items-start gap-3">
              ...
              <div className="text-base-300 justify-start text-sm  max-xl:text-[10px] font-light">
          ...
          <div className="w-full flex flex-col justify-start items-start gap-7 sm:pr-20">
            <div className="anim-industry-item will-change-transform self-stretch flex flex-col justify-start items-start gap-3">
              <div className="self-stretch justify-center text-primary-100 text-xl max-xl:text-xs font-bold tracking-[4px]">
                E-COMMERCE
              </div>

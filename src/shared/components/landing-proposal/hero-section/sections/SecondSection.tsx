...
const SecondSection = ({ isActive }: SectionProps) => {
  ...
  return (
    <UiSection>
      <div
        ref={container}
        className="size-full sm:justify-end max-sm:justify-between flex  flex-col sm:gap-20 2xl:gap-32"
      >
        <div className="flex flex-col gap-4 ">
          
          <div className="justify-start ui-title flex flex-col">
            <span className="anim-title text-primary-100 text-2xl sm:text-5xl font-semibold uppercase tracking-[5px] sm:leading-16 block will-change-transform">
              SUCCESSFULL <br />
              BRANDS <span className="text-white font-light">AND</span>
            </span>
            <span className="anim-title text-white text-2xl sm:text-5xl font-light uppercase tracking-[5px] sm:leading-16 block will-change-transform">
              IDENTITIES
            </span>
          </div>

          <div className="flex flex-col gap-5">
            <div className="flex max-sm:flex-col gap-4 anim-label-group">
              <div className="will-change-transform">
                <QuantiqoLabel label="Creative Direction" />
              </div>
              <div className="will-change-transform">
                <QuantiqoLabel label="Branding" />
              </div>
              <div className="will-change-transform">
                <QuantiqoLabel label="Brand Identities" />
              </div>
            </div>
            <div className="anim-label-group">
              <div className="will-change-transform inline-block">
                <QuantiqoLabel label="Brand Assets and Pitchs" />
              </div>
            </div>
          </div>
        </div>

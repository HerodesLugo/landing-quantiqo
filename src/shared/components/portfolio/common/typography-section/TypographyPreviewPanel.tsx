...
const TypographyPreviewPanel: React.FC<TypographyPreviewPanelProps> = ({
  ...
  <div className={`bg-[#F6F7F9] p-8 md:px-12 md:py-10 w-full relative overflow-y-auto overflow-x-hidden flex flex-col justify-between ${fontFamilyClass}`}>
    <GradientBlur
    ...
    <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_250px] gap-x-8 gap-y-2 items-center w-full relative z-10 shrink-0">
      ...
      <div className="hidden md:flex items-center w-full h-full">
        <div className={`w-3 h-3 ${dotColorClass} rounded-full shrink-0 z-10`} />
      ...
      <div className="flex flex-col gap-1 text-left">
        ...
        <span className="text-sm text-gray-500">{fontFamilyName} Regular, Text &gt; 64 px</span>
      </div>
      ...
      <div className="flex flex-col gap-1 text-left">
        ...
        <span className="text-sm text-gray-500">{fontFamilyName} Medium, Text &gt; 18 px</span>
      </div>
    </div>
    ...
    <div className="grid grid-cols-1 md:grid-cols-[auto_1fr_250px] gap-x-8 items-start w-full relative z-10 shrink-0 pb-6 md:pb-0">
      ...
      <div className="flex flex-col gap-1 text-left md:mt-3">
        ...
        <span className="text-sm text-gray-500">{fontFamilyName} Regular, Text &gt; 32 px</span>
      </div>
      ...
      <div className="hidden md:block relative w-full h-[60px] md:mt-4">
        <div className={`w-3 h-3 ${dotColorClass} rounded-full absolute top-[-5px] left-0 z-10`} />
      ...
      <div className="flex flex-col gap-1 text-left mt-6 md:mt-[34px]">
        <span className="text-xl font-medium text-black">Body</span>
        <span className="text-sm text-gray-500">{fontFamilyName} Regular, Text &gt; 14px</span>
      </div>
    </div>
  </div>
);

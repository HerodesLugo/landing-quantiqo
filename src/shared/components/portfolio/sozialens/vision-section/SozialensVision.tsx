...
const SozialensVision = () => {
  return (
    <div className="relative w-full flex items-center justify-center max-md:flex-col">
      ...
      <div className="absolute -top-1 max-md:hidden">
        <Image
      ...
      <div className="w-full md:justify-end flex md:pr-10 justify-center">
        <Image
          src="/images/portfolios/sozialens/vision-decorator.png"
          alt="logo"
          className="max-md:h-[14.1875rem] max-md:w-[13.9375rem]"
          height={515}
          width={505}
        />
      </div>

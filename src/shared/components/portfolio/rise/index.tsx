...
const RiseLabs = () => {
  return (
    <>
      ...
      <RiseVisionLayout />
      <RiseBentoGrid />
      <FontView fontName="Host Grotesk" fontClass="font-['Host Grotesk']" gradientClass="from-green-500 to-green-200" />
      ...
      <div className="h-[70rem] flex items-center justify-center">
        <Image
          src="/images/portfolios/rise-labs/banner-2.webp"
          className="w-[56rem] h-[60.5rem] object-top"
          width={7680}
          height={4316}
          alt="banner"
        />
      ...
      <RiseProductShowcase />
      <div className="h-[75.1875rem] border mb-11">
        <Image

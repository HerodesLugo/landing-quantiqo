...
const ProductShowcase = () => {
  return (
    <div className="md:h-[52rem] flex gap-5 max-md:flex-col max-md:mt-5">
      <div className="md:w-1/2 md:overflow-hidden flex flex-col gap-9 max-md:gap-0">
        ...
        <div className="h-40 max-md:h-auto max-md:py-6 relative max-md:flex max-md:flex-col max-md:px-5 max-md:gap-1">
